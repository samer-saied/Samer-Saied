...
export default function InfoProfileWidget() {
  return (
    <>
      <div className="w-full p-4 mb-6 rounded-lg shadow bg-gradient-to-b from-transparent md:w-1/3 to-darknight sm:inline-block">
        <div className="flex items-start text-left ">
          <div className="flex-shrink-0">
            <div className="relative inline-block">
              <a href="#" className="relative block">
                <img
                  alt="samer's profile image"
                  src="/images/samersaied.png"
                  className="mx-auto object-cover rounded-full h-16 w-16 border-2 border-white shadow-2xl"
                />
              </a>
            </div>
          </div>
        ...
        <div className="mt-3">
          ...
          <p className="max-w-xs mt-1 font-light text-white text-left">
        ...
        <div className="flex items-start justify-around mt-6 text-gray-100">
          {/*======================== FACEBOOK *========================*/}
          <a
