"use client";
function ButtonWidget({ link, index }) {
    ...
    <div key={link.name + index}>
      {link.name == "Github" && (
        <button
          ...
          type="button"
          className="flex items-center justify-center w-48 mt-3 bg-black h-14 rounded-xl"
        >
          <div className="mr-3">
      ...
      {link.name == "Website" && (
        ...
        >
          ...
          <div>
            ...
            <div className="-mt-1 font-sans text-xl font-semibold">Website</div>
          </div>
        </button>
      )}
      {link.name == "PlayStore" && (
      ...
      {link.name == "appleStore" && (
        <button
          ...
          type="button"
          className="flex items-center justify-center w-48 mt-3 text-white bg-black border border-black h-14 rounded-xl"
        >
          <div className="mr-3">
