...
const FooterSection = () => {
  ...
  return (
    ...
    <footer className="bg-white w-full dark:bg-gray-800 py-8">
      <div className="max-w-screen-xl px-4 mx-auto">
        ...
        <div className="text-center text-gray-50 dark:text-gray-50 pt-10 sm:pt-12 font-light flex items-center justify-center">
          Copyright <span className="px-1"> © </span> 2023 Created by Samer Saied
        </div>
      </div>
    </footer>
