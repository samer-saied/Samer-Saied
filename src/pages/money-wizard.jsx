...
export default function MoneyWizardProject() {
 ...
 <div className=" md:flex md:flex-row md:content-between md:justify-center mt-10">
          ...
          <button
            ...
            type="button"
            className="flex items-center justify-center w-48 md:mx-5 mt-5 text-white bg-black rounded-lg h-14"
          >
            <div className="mr-3">
          ...
          <button
            ...
            type="button"
            className="flex items-center justify-center w-48 md:mx-5 mt-5 text-black bg-transparent border border-black h-14 rounded-xl"
          >
            <div className="mr-3">
